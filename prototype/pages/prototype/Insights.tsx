           ...
           <div className="md:col-span-8 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
               <div className="flex justify-between items-center mb-6">
                   ...
                   <div className="flex gap-3 text-xs font-medium text-slate-500">
                       <span className="flex items-center gap-1"><div className="w-3 h-3 bg-slate-100 rounded-sm"></div> No Data</span>
                       <span className="flex items-center gap-1"><div className="w-3 h-3 bg-red-400 rounded-sm"></div> Low</span>
                       <span className="flex items-center gap-1"><div className="w-3 h-3 bg-emerald-500 rounded-sm"></div> High</span>
                   </div>
               </div>
               ...
               <div className="grid grid-cols-7 gap-2">
                   {Array.from({length: 30}).map((_, i) => {
                       ...
                       return (
                           <div key={i} className={`aspect-square rounded-md ${color} hover:scale-110 transition-transform cursor-pointer relative group`}>
           ...
           <div className="md:col-span-4 bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex flex-col">
               ...
               <div className="space-y-3 mt-8">
                   <div className="flex justify-between items-center text-sm">
                       <span className="flex items-center gap-2 font-medium"><div className="w-3 h-3 bg-stoic-blue rounded-full"></div> Wisdom</span>
                       <span className="font-bold">42%</span>
                   </div>
                   <div className="flex justify-between items-center text-sm">
                       <span className="flex items-center gap-2 font-medium"><div className="w-3 h-3 bg-indigo-500 rounded-full"></div> Courage</span>
                       <span className="font-bold">28%</span>
                   </div>
                   <div className="flex justify-between items-center text-sm">
                       <span className="flex items-center gap-2 font-medium"><div className="w-3 h-3 bg-slate-200 rounded-full"></div> Others</span>
               ...
               <div className="flex flex-col md:flex-row gap-6 relative z-10">
                   ...
                   <div>
                       ...
                       <p className="text-indigo-100 leading-relaxed mb-6 max-w-3xl text-lg">
                           "This week you've shown a clear pattern: <strong>Work stress triggers your anxiety</strong> (mentioned 5 times), but your mood consistently improves when you practice <strong>Gratitude</strong> in the evening. You're developing better control over your reactions to management feedback—that's a big win for Temperance."
                       </p>
