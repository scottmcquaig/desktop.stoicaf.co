...
import { User, Sliders, Bell, CreditCard, LogOut } from 'lucide-react';
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid gap-3">
                    ...
                    <label className="flex items-center gap-4 p-4 border border-slate-200 rounded-xl cursor-pointer hover:bg-slate-50 transition-colors group">
                      <div className="w-5 h-5 rounded-full border-2 border-slate-300 group-hover:border-stoic-blue"></div>
                      <div>
                        <div className="font-bold text-slate-900">Roast Me (Humorous & Sarcastic)</div>
                        <div className="text-sm text-slate-500">For when you need a dose of humbling humor.</div>
                      </div>
                    </label>
                  </div>
                </div>
                ...
                <div className="space-y-4 pt-4 border-t border-slate-100">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-12 h-7 bg-stoic-blue rounded-full relative cursor-pointer transition-colors">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="w-12 h-7 bg-slate-200 rounded-full relative cursor-pointer transition-colors hover:bg-slate-300">
            ...
            {activeTab === 'Subscription' && (
              <div>
                <div className="bg-sky-50 border border-sky-100 rounded-xl p-6 mb-8 flex justify-between items-center">
                  ...
                  <div className="bg-white px-3 py-1 rounded-full text-xs font-bold text-emerald-600 border border-emerald-100 shadow-sm">
                    Active
                  </div>
                </div>
