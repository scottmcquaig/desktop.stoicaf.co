        ...
        <CardContent className="pt-8">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1">
              <Label htmlFor="displayName" className="text-xs font-bold uppercase text-slate-700">
                Display Name
              </Label>
              <Input
                id="displayName"
          ...
          <p className="text-center text-sm text-slate-600 mt-6">
            ...
            <Link href="/auth/signin" className="text-stoic-blue font-bold hover:underline">
              Sign In
            </Link>
          </p>
        </CardContent>
