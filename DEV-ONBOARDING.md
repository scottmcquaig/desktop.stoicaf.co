...
# ⚙️ **3. Developer Onboarding Guide (Markdown)**
...
### **Living Notebook**
- Each day creates a single `entry` doc  
...
- Android: Google Play  
- iOS: App Store  
- Use Flutter’s flavors for staging/production  
...
- Ensure App Check enabled  
- Always enforce Firestore rule tests before merging  
